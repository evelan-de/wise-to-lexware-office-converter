...
export function Footer() {
  return (
    <footer className="relative -mx-4 mt-16 px-4 pt-20 pb-10 section-footer overflow-hidden">
      {/* Animated Glow Orbs */}
        ...
        <div className="space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div className="glass-card rounded-2xl p-6 text-center group">
              <div className="flex justify-center mb-4">
                <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-emerald-500/20 to-emerald-600/20 border border-emerald-500/30 flex items-center justify-center group-hover:glow-teal transition-all duration-300">
            ...
            <div className="glass-card rounded-2xl p-6 text-center group">
              <div className="flex justify-center mb-4">
                <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-secondary/20 to-primary/20 dark:from-primary/20 dark:to-secondary/20 border border-secondary/30 dark:border-primary/30 flex items-center justify-center group-hover:glow-teal transition-all duration-300">
                  <svg className="w-7 h-7 text-secondary dark:text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="text-center">
            ...
            >
              <Image
                ...
                width={300}
                height={100}
                className="mx-auto hover:opacity-90 transition-opacity dark:brightness-110"
              />
            </a>
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center">
              <div className="w-20 h-1 rounded-full bg-gradient-to-r from-transparent via-secondary/50 dark:via-primary/50 to-transparent" />
            </div>
          </div>
          ...
          <div>
            <nav className="flex flex-wrap justify-center items-center gap-x-8 gap-y-3 text-sm mb-8">
              <Link
                href="/blog"
                className="text-muted-foreground hover:text-secondary dark:hover:text-primary transition-colors"
              >
                Blog
              </Link>
              <Link
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-muted-foreground hover:text-secondary dark:hover:text-primary transition-colors inline-flex items-center gap-1.5"
              >
