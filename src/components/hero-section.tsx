    ...
    <>
      ...
      <header className="relative mb-16 pt-8">
        ...
        <div className="absolute inset-0 -z-10 overflow-hidden">
          <div className="absolute top-0 right-0 w-96 h-96 bg-[#3C777B]/15 rounded-full blur-[100px]" />
          <div className="absolute bottom-0 left-0 w-96 h-96 bg-[#DDA95B]/10 rounded-full blur-[100px]" />
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-[#3C777B]/10 dark:bg-[#3C777B]/30 text-[#08292E] dark:text-[#5A9A9E]">
            ...
            <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight text-foreground">
              WISE zu{' '}
              <span className="bg-gradient-to-r from-[#08292E] to-[#3C777B] dark:from-[#DDA95B] dark:to-[#F3C079] bg-clip-text text-transparent">
                Lexware Office
              </span>{' '}
              Konverter
            </h1>
          ...
          <div className="relative">
            <div className="space-y-4">
              ...
              <div className="flex justify-center">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#F3C079] to-[#C88F44] flex items-center justify-center shadow-lg animate-bounce">
              ...
              <div className="animate-float-delayed relative bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-lg p-4">
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#08292E] to-[#3C777B] flex items-center justify-center">
            ...
            {/* Decorative elements */}
            <div className="absolute -top-4 -right-4 w-20 h-20 border-2 border-dashed border-[#3C777B]/30 dark:border-[#3C777B]/50 rounded-xl -z-10" />
            <div className="absolute -bottom-4 -left-4 w-20 h-20 border-2 border-dashed border-[#DDA95B]/30 dark:border-[#DDA95B]/50 rounded-xl -z-10" />
          </div>
        </div>
      </header>
    </>
